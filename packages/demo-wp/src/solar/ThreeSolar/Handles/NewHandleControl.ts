...
class HandleControl {
  ...
  testHudHandleMiddleLeft: Handle;
  ...
  constructor() {
    ...
    this.testHudHandleMiddleLeft = new Handle({
      dimensions: new THREE.Vector3(0.2, 0, 0.2),
  ...
  removeFromScene() {
    ...
    this.testHudHandleMiddleLeft.handleObject.removeFromParent();
  }
}
